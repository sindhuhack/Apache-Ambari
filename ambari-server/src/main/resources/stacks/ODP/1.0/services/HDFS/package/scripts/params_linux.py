...
for ns, dfs_ha_namenode_ids in dfs_ha_namenode_ids_all_ns.items():
  ...
  if not is_empty(dfs_ha_namenode_ids):
    ...
    print("dfs_ha_namemodes_ids_list",dfs_ha_namemodes_ids_list)
...
if has_ranger_admin:
  rangerlookup_create_user = True if 'rangerlookup_password' in config['configurations']['ranger-env'] else False
