...
if enable_ranger_yarn and is_supported_yarn_ranger:
  ...
  if xml_configurations_supported and stack_supports_ranger_audit_db:
    xa_audit_db_is_enabled = config['configurations']['ranger-yarn-audit']['xasecure.audit.destination.solr']
...
yarn_hbase_app_hdfs_path = format("/odp/apps/{version}/hbase")
yarn_service_app_hdfs_path = format("/odp/apps/{version}/yarn")
